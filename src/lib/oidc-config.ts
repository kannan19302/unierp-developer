 ...
 * "unierp-developer-platform", seeded by data/prisma/seed-oidc-clients.ts as a PUBLIC
...
export const oidcConfig: OidcClientConfig = {
  ...
  clientId: "unierp-developer-platform",
  redirectUri:
    (typeof window !== "undefined" ? window.location.origin : "http://localhost:4008") +
    "/auth/callback",
