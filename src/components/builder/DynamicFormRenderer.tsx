...
export function DynamicFormRenderer({
      ...
      case "Image":
        return (
          ...
          >
            ...
            >
              Drop {f.type === "Image" ? "image" : "file"} here or click to
              upload
            </span>
      ...
      case "Table": {
        ...
        if (cols.length === 0) {
          return (
            ...
            >
              Please define columns in field options (e.g. Item:Text)
            </div>
          );
        }
        ...
        return (
          <div style={{ position: "relative", height: customHeight }}>
            ...
            <input
              ...
              style={{
                ...inputStyle,
                paddingLeft: f.type === "Currency" ? "28px" : "var(--space-2)",
                height: "100%",
              }}
  ...
  fields.forEach((f) => {
    if (f.type === "Section Break") {
      ...
      currentSection.columns[currentSection.columns.length - 1]?.fields.push({
        field: f,
      });
    }
  });
        ...
        return (
          <React.Fragment key={`sec_${sIdx}`}>
            {section.breakField &&
              ...
              section.breakField.label !== "New Section Break" && (
                <h3
                  style={{
                    fontSize: "var(--text-lg)",
                    fontWeight: "var(--weight-semibold)",
                    ...
                    margin: 0,
                    marginTop: sIdx > 0 ? "var(--space-4)" : 0,
                  }}
                >
                  {section.breakField.label}
                </h3>
                        ...
                        >
                          <div
                            ...
                            style={{
                              ...
                              height: "100%",
                              display: "flex",
                              flexDirection: isCheck ? "row-reverse" : "column",
                              justifyContent: isCheck
                                ? "flex-end"
                                : "flex-start",
                              alignItems: isCheck ? "center" : "stretch",
                              gap: isCheck ? "var(--space-2)" : 0,
                            }}
                          >
                            {!isButton && !isHtml && (
                              <label
