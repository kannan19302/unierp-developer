        ...
        <div style={{ overflowY: "auto", flex: 1 }}>
            ...
            {(webhooks || []).map((wh, idx) => (
              ...
              >
                ...
                <DarkInput label="Event Trigger">
                  ...
                  >
                    <option value="record.created" style={{ color: "black" }}>
                      Record Created
                    </option>
                    <option value="record.updated" style={{ color: "black" }}>
                      Record Updated
                    </option>
                    <option value="record.deleted" style={{ color: "black" }}>
                      Record Deleted
                    </option>
                  </select>
                </DarkInput>
            ...
            <button
              ...
              onClick={() =>
                updateFormSettings({
                  webhooks: [
                    ...(webhooks || []),
                    { url: "", event: "record.created", method: "POST" },
                  ],
                })
              }
            >
          ...
          >
            ...
            <button
              ...
              onClick={() => {
                const scripts =
                  useBuilderStore.getState().formSettings.scripts || [];
                updateFormSettings({
                  scripts: [...scripts, { code: "", event: "record.created" }],
                });
              }}
            >
              + Add JS Automation
    ...
    >
      ...
      <div style={{ overflowY: "auto", flex: 1 }}>
        <AccordionSection title="General" icon={Settings} defaultOpen={true}>
          ...
          {selectedField.type !== "Section Break" &&
            selectedField.type !== "Column Break" &&
        ...
        >
          ...
          selectedField.type === "Section Break" ? (
            ...
            <>
              <DarkInput
                label={`Width (Columns): ${selectedField.columnSpan || 12}/12`}
              >
                <input
                  type="range"
                  min="1"
        ...
        >
          ...
          >
            <DarkInput
              ...
              description="Add conditions to dynamically show/hide this field"
            >
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                >
                  <select
                    style={{ ...inputStyle, minHeight: "32px", flex: 1 }}
                    value={
                      selectedField.visibilityRule?.match(
                        /(==|!=|>|<|>=|<=|contains)/,
                      )?.[0] || "=="
                    }
                    onChange={(e) => {
                      ...
                      const val =
                        selectedField.visibilityRule
                          ...
                          .join(" ") || "";
                      updateField(selectedField.id, {
                        visibilityRule: `${fieldName} ${e.target.value} ${val}`,
                      });
                    }}
                  >
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const fieldName =
                        ...
                        "{field}";
                      const op =
                        selectedField.visibilityRule?.split(" ")[1] || "==";
                      updateField(selectedField.id, {
                        visibilityRule: `${fieldName} ${op} '${e.target.value}'`,
                      });
                    }}
                  />
                </div>
        ...
        >
          {(selectedField.type === "Data" ||
            ...
            selectedField.type === "Float") && (
            <DarkInput
              label="Computed Formula"
              description="Wrap field names in curly braces. Auto-calculated on change."
            >
              <input
                type="text"
                style={{ ...inputStyle, fontFamily: "monospace" }}
