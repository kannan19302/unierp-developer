...
export default function DataImportPage() {
    ...
    try {
      Papa.parse(selectedFile, {
        ...
        complete: async (results) => {
          ...
          // Execute import
          await client.post(`/builder/data-imports/${job.id}/execute`, {
            rows,
          });
  ...
  const importColumns: ListColumn[] = [
    { key: "name", header: "Name" },
    {
      key: "targetModel",
      header: "Target",
      render: (v) => <span className={styles.s2}>{String(v)}</span>,
    },
    ...
    { key: "totalRows", header: "Rows" },
    {
      key: "importedRows",
      header: "Imported",
      render: (v) => <span className="ui-text-success">{String(v)}</span>,
    },
    {
      key: "failedRows",
      header: "Failed",
      render: (v, row) => {
        const r = row as unknown as ImportJob;
        return (
          <span
            style={{
              color:
  ...
  return (
    <div className="p-6 ui-stack-5">
      ...
      {/* Import Wizard Modal */}
      {showWizard && (
        <div className={styles.s3} onClick={() => setShowWizard(false)}>
          <div
                ...
                <div className="ui-stack-4">
                  <div className="ui-form-group">
                    ...
                    <input
                      className="ui-input"
                      type="text"
                      placeholder="e.g. Q1 Customer Import"
                      value={importName}
                  ...
                  <div className="ui-flex-end ui-gap-2">
                    ...
                    <button
                      className="ui-btn ui-btn-primary"
                      disabled={!selectedFile || !importName}
                      onClick={() => setStep(2)}
                    >
                      Next: Map Columns
                    </button>
                ...
                <div className="ui-stack-4">
                  <div className={styles.s20}>
                    ...
                    <div className={styles.s22}>
                      <span className="ui-text-muted">Name:</span>
                      <span>{importName}</span>
                      <span className="ui-text-muted">Target:</span>
                      <span>
                        {MODELS.find((m) => m.value === targetModel)?.label}
                      </span>
                      <span className="ui-text-muted">File:</span>
