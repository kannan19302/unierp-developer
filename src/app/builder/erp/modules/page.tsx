...
const MODULES_LIST = [
  {
    ...
    description:
      "Track and manage on-site maintenance requests with SLA timers",
  },
  {
    id: 2,
    ...
    description:
      "Custom insurance claim processing module with approval chains",
  },
  {
    id: 3,
    name: "Research Grant",
    ...
    description:
      "Manage university research grant applications and disbursements",
  },
  {
    id: 4,
    ...
    description:
      "Digital inspection reports with photo attachments and scoring",
  },
  {
    id: 5,
...
function ERPModulesPageContent() {
  ...
  return (
    <div className="p-6 ui-stack-5">
      ...
      {/* Layout: List + Detail */}
      <div
        style={{ gridTemplateColumns: selectedModule ? "340px 1fr" : "1fr" }}
        className={styles.s1}
      >
        {/* List Side */}
              ...
              <div className={styles.s8}>
                <div>
                  ...
                  <p className="ui-text-xs-muted m-0">
                    {mod.module} Module · {mod.createdAt}
                  </p>
                </div>
                <span
                  style={{
            ...
            <div className="ui-card p-4">
              <div className={styles.s11}>
                ...
                <div className={styles.s13}>
                  <button
                    onClick={() =>
                      router.push(`/builder/erp/modules/${currentMod.id}`)
                    }
                  ...
                  <button
                    onClick={() => setDeleteTarget(currentMod.id)}
                    className={`ui-btn ${styles.s15}`}
                  >
                    <Trash2 size={13} />
                  </button>
                </div>
                ...
                <div className="ui-stack-2">
                  ...
                  <div className={styles.s18}>
                    {["Field Name", "Type", "Required", ""].map((h) => (
                      <span key={h} className={styles.s19}>
                        {h}
                      </span>
                    ))}
                  </div>
              ...
              {activeSection === "schema" && (
                <div className="ui-stack-3">
                  ...
                  <button
                    ...
                    className={`ui-btn ui-btn-secondary ${styles.s31}`}
                  >
                    <Link size={13} />
...
export default function ERPModulesPage() {
  return (
    <Suspense
      fallback={<div className={styles.s32}>Loading Custom Modules...</div>}
    >
