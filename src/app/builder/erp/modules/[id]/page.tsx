...
export default function EntityDesignerWorkspace() {
  ...
  const [activeTab, setActiveTab] = useState<
    "schema" | "permissions" | "relationships"
  >("schema");
      ...
      <div className={styles.s6}>
        ...
        <div className={styles.s7}>
          <div className={styles.s8}>
            <h3 className={styles.s9}>Database Columns</h3>
          ...
          <div className={styles.s14}>
            <div className={styles.s15}>
              <button
                ...
                className={`ui-btn ${activeTab === "schema" ? "ui-btn-primary" : ""} ${styles.s16}`}
                style={{
                  background: activeTab === "schema" ? "" : "transparent",
                  color:
                    activeTab === "schema" ? "" : "var(--color-text-secondary)",
                }}
              >
                <Database size={14} />
                Schema
              ...
              <button
                ...
                className={`ui-btn ${activeTab === "permissions" ? "ui-btn-primary" : ""} ${styles.s16}`}
                style={{
                  background: activeTab === "permissions" ? "" : "transparent",
                  color:
          ...
          <div className={styles.s17}>
            {activeTab === "schema" && (
              <div className={`ui-card ${styles.s18}`}>
                <h2 className={styles.s19}>Table Schema</h2>
                <DndContext
                  sensors={sensors}
                    ...
                    <div className="ui-stack-3">
                      {fields.length === 0 ? (
                        <div className={styles.s20}>
                          No fields added yet. Click a field type on the left to
                          add it.
                        </div>
                      ) : (
                        fields.map((field) => (
            ...
            {activeTab === "permissions" && (
              <div className="ui-card p-6">
                <h2 className={styles.s19}>Role-Based Access</h2>
                <p className={styles.s22}>
                  Define which roles can interact with records in this custom
                  module.
                </p>
                {/* Mocked UI for now */}
        ...
        {activeTab === "schema" && (
          <div className={styles.s23}>
            <div className={styles.s8}>
              <h3 className={styles.s24}>Field Properties</h3>
            </div>
                ...
                <div className="ui-stack-4">
                  ...
                  {selectedField.type === "link" && (
                    <div className="ui-form-group">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          updateSelectedField("linkTarget", e.target.value)
                        }
                      >
                  ...
                  <div className={`ui-form-group ${styles.s25}`}>
                    <input
                      ...
                      onChange={(e) =>
                        updateSelectedField("unique", e.target.checked)
                      }
                    />
