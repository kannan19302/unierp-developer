...
const STRUCTURED_DATA_TYPES = [
  ...
  {
    type: "Product",
    description: "Product schema for pricing pages",
    pages: 1,
  },
  { type: "Article", description: "Article schema for blog posts", pages: 24 },
  {
    type: "Organization",
    description: "Organization schema for homepage",
    pages: 1,
  },
];
...
function ScoreBadge({ score }: { score: number }) {
  ...
  return (
    <div
      ...
      className={styles.s1}
    >
      <span style={{ color: color }} className={styles.s2}>
        {score}
      </span>
    </div>
  );
...
function WebSEOPageContent() {
  ...
  const activeTabParam = searchParams.get("subtab");
  const activeTab: "pages" | "technical" | "structured" =
    activeTabParam === "technical" || activeTabParam === "structured"
      ? activeTabParam
      : "pages";
  ...
  const displayPageId =
    selectedPage || (PAGES_SEO_DB.length > 0 ? PAGES_SEO_DB[0].id : null);
    ...
    <div className="p-6 ui-stack-5">
      ...
      <div className={styles.s3}>
        {[
          ...
          {
            label: "Pages Audited",
            value: PAGES_SEO_DB.length.toString(),
            color: "var(--color-primary)",
            sub: `of ${PAGES_SEO_DB.length} total configs`,
          },
          {
            label: "Open Issues",
            value: "8",
          ...
          <div key={stat.label} className="ui-card p-3">
            ...
            <span style={{ color: stat.color }} className={styles.s5}>
              {stat.value}
            </span>
        ...
        <div className={styles.s8}>
          ...
          <div className="ui-stack-2">
            ...
            {PAGES_SEO_DB.length === 0 && (
              <div className={styles.s14}>No SEO configs yet.</div>
            )}
          </div>
          ...
          <div className="ui-stack-4">
            {currentPage ? (
              <div className="ui-card p-4">
                <div className={styles.s15}>
                  <div className="ui-hstack-3">
                    ...
                    <div>
                      <h2 className={styles.s16}>
                        {currentPage.title || "Untitled"}
                      </h2>
                      <p className="ui-text-xs-muted m-0">
                        Page ID: {currentPage.pageId} · Last updated:{" "}
                  ...
                  <div className="ui-flex ui-gap-2">
                    <button
                      className="ui-btn ui-btn-secondary ui-text-danger"
                      onClick={() => deleteItem(currentPage.id)}
                    >
                      <span>Delete</span>
                    </button>
                    <button
                ...
                <div className={styles.s17}>
                  ...
                  <p className={styles.s20}>
                    yourdomain.com
                    {currentPage.canonicalUrl || `/${currentPage.pageId}`}
                  </p>
                  <p className={styles.s21}>
                    {currentPage.description || (
                      <span className={styles.s22}>
                        ⚠ No meta description set — Google will auto-generate
                        from page content
                      </span>
                    )}
                  </p>
              ...
              <div className={`ui-card ${styles.s28}`}>
                ...
                <p className={styles.s31}>
                  Click a configuration on the left to view and edit details.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="ui-stack-4">
          ...
          <div className="ui-card p-4">
            ...
            <p className={styles.s33}>
              Configure your public-facing custom domain name. SSL certificate
              generation and DNS routing check will run automatically.
            </p>
            <div className={styles.s34}>
              <input
                className={`ui-input ${styles.s35}`}
              ...
              <button
                ...
                onClick={() => {
                  alert(
                    "DNS A Record verified (IP 76.76.21.21). SSL Certificate successfully provisioned via Let’s Encrypt!",
                  );
                }}
              >
                Verify DNS & SSL
          ...
          {[
            ...
            },
            {
              ...
              status: "84/100",
              description:
                "Core Web Vitals: LCP 2.1s · FID 18ms · CLS 0.04 — All passing",
              action: "Run Audit",
              actionColor: "var(--color-primary)",
            },
            {
              ...
              <div className={styles.s36}>
                <div className="flex-1">
                  <div className={styles.s37}>
                    ...
                    <span
                      style={{
                        background: `${item.actionColor}18`,
                ...
                <button
                  ...
                  className={`ui-btn ui-btn-secondary ${styles.s41}`}
                >
                  <Edit3 size={12} />
            ...
            {STRUCTURED_DATA_TYPES.map((sd) => (
              <div key={sd.type} className="ui-card p-4">
                ...
                <button
                  ...
                  className={`ui-btn ui-btn-secondary ${styles.s48}`}
                >
                  <Edit3 size={12} />
                  <span>Configure</span>
                </button>
...
export default function WebSEOPage() {
  return (
    <Suspense
      fallback={<div className={styles.s52}>Loading SEO Manager...</div>}
    >
      <WebSEOPageContent />
    </Suspense>
  );
