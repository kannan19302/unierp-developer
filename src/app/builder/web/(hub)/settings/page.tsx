...
function WebSettingsPageContent() {
  const client = useApiClient();
  const searchParams = useSearchParams();
  const subtabParam = searchParams.get("subtab");
  const activeTab: "theme" | "code" | "general" =
    subtabParam === "code" || subtabParam === "general" ? subtabParam : "theme";
    ...
    const fetchData = async () => {
      try {
        const [settingsData, templatesData] = await Promise.all([
          client.get("/builder/web-settings"),
          client.get<any[]>("/builder/web-templates"),
        ]);
  ...
  return (
    <div className={styles.s1}>
      ...
      <div className={styles.s2}>
        {/* Navigation */}
        <SubTabBar tabs={SETTINGS_SUB_TABS} />
                  ...
                  {templates?.map((t: any) => (
                    ...
                    >
                      ...
                      <div
                        style={{
                          background:
                            formData.activeTemplateId === t.id
                    ...
                    <div className="ui-stack-3">
                      <div className="ui-form-group">
                        ...
                        <select
                          className="ui-input"
                          value={
                            formData.themeTokens?.fonts?.heading ||
                            "Inter, sans-serif"
                          }
                          onChange={(e) =>
                            setFormData((prev: any) => ({
                      ...
                      <div className="ui-form-group">
                        ...
                        <select
                          className="ui-input"
                          value={
                            formData.themeTokens?.fonts?.body ||
                            "Inter, sans-serif"
                          }
                          onChange={(e) =>
                            setFormData((prev: any) => ({
          ...
          {activeTab === "code" && (
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setFormData({ ...formData, globalCss: e.target.value })
                }
                placeholder={
            ...
            <div className="ui-stack-4">
              ...
              <div className="ui-form-group">
                ...
                <input
                  className="ui-input"
                  type="text"
                  defaultValue="UniERP Public Site"
                />
              </div>
              <div className="ui-form-group">
