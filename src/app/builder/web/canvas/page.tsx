...
import { resolveBlockComponent } from "@/components/builder/blocks/registry";
...
function CanvasContent() {
  ...
  return (
    <div className={`builder-canvas ${styles.s1}`} onClick={handleCanvasClick}>
      {sections.length === 0 ? (
        ...
        sections.map((section) => {
          ...
          return (
            ...
            >
              {isSelected && (
                <div className={styles.s4}>{section.label || section.type}</div>
              )}
