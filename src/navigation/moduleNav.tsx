...
function readNavContext(): {
  ...
  if (userJson) {
    try {
      ...
      role = u.role || "";
      isSuperAdmin =
        u.role === "SUPER_ADMIN" || u.email === "admin@uni-erp.com";
    } catch {
 ...
 */
export const getAppSpecificNavigation = (
  pathname: string,
): {
  title: string;
  ...
  if (routeSegment) {
    ...
    if (descriptor) {
      ...
      if (isVisible) {
        const navItems =
          typeof descriptor.nav === "function"
            ? descriptor.nav(ctx)
            : descriptor.nav;
        return {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              name: "Trainings & Certs",
              href: "/hr/advanced/trainings",
              icon: GraduationCap,
            },
            {
              name: "Operations & Service Hub",
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              name: "Stock Reservations & Analytics",
            ...
            {
              name: "Reorder Rules & Automation",
              href: "/inventory/reorder-rules",
              icon: ShoppingCart,
            },
            {
              name: "QA Templates & Routing",
              href: "/inventory/qa-templates",
              icon: ShieldCheck,
            },
            {
              name: "Expiry, FEFO & Recalls",
            ...
            {
              name: "Container & Pallets",
              href: "/inventory/container-pallet",
              icon: Package,
            },
            {
              name: "Catch-Weight & Recall",
            ...
            {
              name: "Cold Chain & Write-Off",
              href: "/inventory/cold-chain-writeoff",
              icon: Box,
            },
            {
              name: "Velocity & ABC-XYZ",
  ...
  if (pathname.startsWith("/manufacturing")) {
    return {
      ...
      items: [
        ...
        {
          name: "Operator Shop Floor",
          href: "/manufacturing/shop-floor",
          icon: Cpu,
        },
        {
          name: "Quality Control & NCR",
  ...
  if (pathname.startsWith("/storage")) {
    return {
      ...
      items: [
        ...
        {
          name: "Storage & Templates Pro",
          href: "/storage/advanced",
          icon: Database,
        },
      ],
    };
  ...
  if (
    ...
    return {
      ...
      items: [
        ...
        {
          name: "Advanced Messaging & Threading",
          href: "/communication/advanced",
          icon: Mail,
        },
      ],
    };
          ...
          items: [
            {
              ...
              href: "/workflows/escalations",
              icon: ShieldAlert,
            },
            {
              name: "Workflow Simulator",
              href: "/workflows/simulation",
              icon: Play,
            },
          ],
        },
  ...
  if (pathname.startsWith("/settings")) {
    ...
    const items: SidebarItem[] = [
      { name: "Dashboard", href: "/saas/portal", icon: Home },
      {
        ...
        items: [
          ...
          },
          {
            ...
            href: "/saas/security?tab=permissions",
            icon: LayoutGrid,
          },
          {
            name: "Login impersonation",
            href: "/saas/security?tab=impersonate",
            icon: UserIcon,
          },
          {
            name: "Delegations & OOO",
            href: "/saas/security?tab=delegations",
            icon: Users,
          },
        ],
      },
      {
        ...
        items: [
          {
            name: "Security Policies Hub",
            href: "/saas/security",
            icon: ShieldAlert,
          },
          {
            name: "Compliance & Governance Hub",
      ...
      },
      {
        ...
        items: [
          {
            name: "Approval Operations Hub",
            href: "/workflows",
            icon: CheckSquare,
          },
          {
            name: "Workflow Builder Hub",
            href: "/builder/erp/workflows",
            icon: GitFork,
          },
          {
            name: "Automation Rules",
            href: "/saas/admin?tab=automation",
            icon: Zap,
          },
        ],
      },
      {
        ...
        items: [
          {
            name: "Branding & Communication Hub",
            href: "/saas/settings?tab=branding",
            icon: Image,
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            href: "/saas/admin?tab=db",
            icon: Database,
          },
          {
            name: "Bulk Operations",
            href: "/saas/admin?tab=bulk",
            icon: Layers,
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            href: "/saas/admin?tab=environments",
            icon: Server,
          },
          {
            name: "System Updates",
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Import / Export Hub", href: "/saas/exports", icon: Upload },
          {
            ...
            href: "/saas/settings?tab=localization",
            icon: Globe,
          },
          {
            name: "DevOps & Telemetry",
            href: "/saas/admin?tab=devops",
            icon: Server,
          },
          {
            name: "Data Quality",
            href: "/saas/admin?tab=data-quality",
            icon: ShieldCheck,
          },
        ],
      },
        ...
        items: [
          {
            ...
            href: "/saas/admin?tab=reports",
            icon: FileText,
          },
          {
            name: "Activity Feed",
            href: "/saas/admin?tab=activity",
            icon: Activity,
          },
          {
            name: "Notification Prefs",
            href: "/saas/settings?tab=notifications",
            icon: Bell,
          },
          {
            name: "Tenant Usage Analytics",
            href: "/saas/admin?tab=analytics",
            icon: BarChart3,
          },
        ],
      },
