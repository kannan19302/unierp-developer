# Architecture Specification: UniERP Developer Platform Portal (`developer-platform`)
...
Developer console for building, testing, previewing, and submitting extensions, custom objects, and APIs.
...
```mermaid
graph LR
  Callers["Allowed Inbound Callers<br/>Third-party developers, ecosystem partners"] --> Repo["<b>developer-platform (L4)</b><br/>UniERP Developer Platform Portal"]
  ...
  Forbidden["Strictly Forbidden<br/>Direct database ORM, L2 runtime internal bypass, L5-L7"] -.-x Repo
...
### Boundary Contract
- **Allowed Inbound Consumers**: Third-party developers, ecosystem partners
...
- **Core Runtime & Languages**: Next.js 14/15, React, Strata Workbench tokens, TypeScript
- **Primary Interface**: `@kannan19302/developer`
...
- **Project Skill**: [`.agents/skills/developer-platform-standards/SKILL.md`](.agents/skills/developer-platform-standards/SKILL.md)
