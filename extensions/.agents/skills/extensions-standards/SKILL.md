---
name: extensions-standards
description: Authoritative standards, architectural boundaries, coding anatomy, and verification gates for extensions.
version: 1.0.0
author: UniERP Architecture Governance
---

# UniERP Curated Extension Ecosystem — AI Agent Guidance & Project Skill

This skill governs all code modification, analysis, and testing within `extensions` (**Layer L6: Extensions**). Every AI agent and software engineer working in this repository MUST follow these rules without exception.
...
- **Allowed Inbound Callers**: Marketplace runtime, tenant apps
