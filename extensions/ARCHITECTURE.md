# Architecture Specification: UniERP Curated Extension Ecosystem (`extensions`)

- **Layer**: Layer L6 (Extensions)
- **Package Identity**: `unierp-extensions`
...
First-party and ecosystem business extensions running strictly inside the L2 Sandbox against public extension contracts.
...
```mermaid
graph LR
  Callers["Allowed Inbound Callers<br/>Marketplace runtime, tenant apps"] --> Repo["<b>extensions (L6)</b><br/>UniERP Curated Extension Ecosystem"]
  Repo --> Outbound["Allowed Outbound Dependencies<br/>@kannan19302/contracts (L0), @kannan19302/extension-api (L2)"]
  
  Forbidden["Strictly Forbidden<br/>Direct database ORM, L3-L5 internal code, Private kernel APIs"] -.-x Repo
...
### Boundary Contract
- **Allowed Inbound Consumers**: Marketplace runtime, tenant apps
- **Allowed Outbound Dependencies**: @kannan19302/contracts (L0); @kannan19302/extension-api (L2)
...
- **Core Runtime & Languages**: TypeScript, Sandbox SDK
- **Primary Interface**: `unierp-extensions`
...
- **Project Skill**: [`.agents/skills/extensions-standards/SKILL.md`](.agents/skills/extensions-standards/SKILL.md)
